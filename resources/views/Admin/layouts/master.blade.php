<!DOCTYPE html>
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-bs-theme="light"
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/theme/assets/libs/toastify-js/src/toastify.css') }}">
...
<body>
    ...
    <script src="{{ asset('assets/theme/assets/libs/toastify-js/src/toastify.js') }}"></script>
