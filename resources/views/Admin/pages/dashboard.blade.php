                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-22 fw-semibold">{{ $totalPendingOrders }}</div>
                                    </div>
                                </div><!-- end card body -->
                            </div><!-- end card -->
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-22 fw-semibold">{{ $totalCompletedOrders }}</div>
                                    </div>
                                </div><!-- end card body -->
                            </div>
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-22 fw-semibold">{{ $danggiao }}</div>
                                    </div>
                                </div><!-- end card body -->
                            </div>
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-22 fw-semibold">{{ $giaothanhcong }}</div>
                                    </div>
                                </div><!-- end card body -->
                            </div>
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-22 fw-semibold">{{ $giaothatbai }}</div>
                                    </div>
                                </div><!-- end card body -->
                            </div>
                        ...
                        <div class="col-xl-2 col-md-3">
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 overflow-hidden">
                                            <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Hủy</p>
                                        </div>
                                        <div class="fs-22 fw-semibold">{{ $giaohuy }}</div>
                                    </div>
                                </div><!-- end card body -->
                            </div>
